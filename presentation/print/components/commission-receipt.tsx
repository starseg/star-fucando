...
import { formatCurrency, formatCommissionPeriod, formatReceiptDate, numberToCurrencyWords } from "@/lib/utils";
...
export function CommissionReceipt({ commission }: CommissionReceiptProps) {
  const { periodStart, periodEnd } = formatCommissionPeriod(commission.referenceMonth);
